...
export function mapProjectResponse(projectResponse: any) {
    return {
        ...
        certifiedCount: projectResponse.certified_count || 1,
        apostilleCount: projectResponse.apostille_count || 1,
        expressCount: projectResponse.express_count || 1,
        classificationCount: projectResponse.classification_count || 1,
        certifiedPrice: parseFloat(projectResponse.certified_price) || 5,
        apostillePrice: parseFloat(projectResponse.apostille_price) || 15,
        expressPrice: parseFloat(projectResponse.express_price) || 15,
        classificationPrice: parseFloat(projectResponse.classification_price) || 15,
        certifiedUnit: projectResponse.certified_unit || 'Stk',
        apostilleUnit: projectResponse.apostille_unit || 'Stk',
        expressUnit: projectResponse.express_unit || 'Stk',
        classificationUnit: projectResponse.classification_unit || 'Stk',
        copiesUnit: projectResponse.copies_unit || 'Stk',
        ...
        positions: (projectResponse.positions || []).map((p: any) => ({
            ...
            unit: p.unit,
            quantity: (parseFloat(p.quantity) || 0).toFixed(2),
