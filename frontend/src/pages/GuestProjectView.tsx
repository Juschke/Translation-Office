                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="flex-1 relative">
                                    ...
                                    <Button
                                        ...
                                        className="absolute right-1 top-1 h-6 w-6 bg-brand-primary text-white rounded-full flex items-center justify-center hover:bg-brand-primary/90 transition shadow-sm"
                                    >
                        ...
                        {activeModal === 'avv' && (
                            <div className="prose prose-sm max-w-none text-slate-700">
                                ...
                                <div className="bg-slate-50 p-6 rounded-sm border border-slate-100 flex items-center justify-between mt-4">
                                    ...
                                    <Button
                                        onClick={() => window.open(`${import.meta.env.VITE_API_URL || 'http://localhost:8000/api'}/guest/project/${token}/avv`, '_blank')}
                                        className="bg-brand-primary text-white hover:bg-brand-primary/90 transition shadow-sm font-bold"
                                    >
                                        Download
                                    </Button>
                                </div>
