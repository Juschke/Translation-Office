...
const VerifyEmail = () => {
 ...
 <h2 className="text-xl font-medium text-slate-800">Verifizierung läuft...</h2>
 ...
 <h2 className="text-xl font-medium text-slate-800">Erfolgreich!</h2>
 ...
 <h2 className="text-xl font-medium text-slate-800">Fehler</h2>
 <p className="text-red-600 mt-2">{message}</p>
 <button
 onClick={() => navigate('/login')}
 className="mt-6 px-6 py-2 bg-slate-800 text-white rounded-sm font-medium hover:bg-slate-700 transition"
 >
 Zurück zum Login
 </button>
 </div>
