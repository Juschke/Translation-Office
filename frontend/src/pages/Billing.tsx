...
const Billing = () => {
 ...
 <button className="w-full sm:w-auto px-4 py-2 bg-slate-900 text-white rounded text-sm font-medium hover:bg-slate-800 transition-all shadow-sm">
 Plan verwalten
 </button>
 <button
 ...
 currentPlanId === key ? "border-slate-900 bg-slate-50 ring-1 ring-brand-600" : "border-slate-100 hover:border-slate-200"
 )}>
 {currentPlanId === key && <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-xs font-medium px-3 py-1 rounded-full">Aktuell</div>}
 ...
 className={clsx(
 "w-full py-2.5 rounded-sm text-xs font-medium transition-all",
 currentPlanId === key
 ...
 className="w-full py-3 bg-slate-900 text-white rounded-sm text-sm font-medium shadow-sm hover:bg-slate-800 transition-all flex justify-center items-center gap-2"
 >
