...
const Profile = () => {
    ...
    return (
        <div className="h-full overflow-y-auto pt-10 pb-20 px-4 scrollbar-thin">
            <div className="max-w-4xl mx-auto fade-in">
                ...
                {message && (
                    <div className={`mb-8 p-4 rounded-sm flex items-center gap-3 ${message.type === 'success' ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-red-50 text-red-700 border border-red-200'}`}>
