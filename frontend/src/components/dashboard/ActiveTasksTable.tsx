            ...
            <div className="overflow-auto flex-1 custom-scrollbar flex flex-col">
                {tasks.length > 0 ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-6 text-center animate-fadeIn">
                        ...
                        <span className="text-xs font-bold text-slate-600">Keine aktiven Aufträge</span>
                        <p className="text-[10px] text-slate-400 mt-0.5">Alle Ihre Projekte sind aktuell abgeschlossen oder pausiert.</p>
                    </div>
                )}
