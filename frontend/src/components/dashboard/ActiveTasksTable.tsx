                                ...
                                >
                                    <td className="px-5 py-3">
                                        <div className="flex flex-col">
                                            <span className="text-xs font-bold text-slate-800 group-hover:text-brand-700 transition truncate max-w-[180px]">
                                                {task.name}
                                            </span>
                                    ...
                                    <td className="px-5 py-3">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-[10px] font-bold text-slate-700 leading-tight">{statusInfo.label}</span>
                                    ...
                                    <td className="px-5 py-3 text-right">
                                        {deadline ? (
                                            <div className="flex flex-col items-end">
                                                <span className={clsx("text-[10px] font-bold", isUrgent ? "text-slate-800" : "text-slate-700")}>
                                                    {deadline.toLocaleDateString('de-DE', { day: '2-digit', month: '2-digit' })}
                                                </span>
                                                <span className={clsx("text-[9px] font-medium", isUrgent ? "text-slate-500" : "text-slate-400")}>
                                                    {daysRemaining} Tage
                                                </span>
                                            </div>
                                        ) : (
