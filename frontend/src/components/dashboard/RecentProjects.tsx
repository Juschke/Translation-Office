...
const RecentProjects: React.FC<RecentProjectsProps> = ({ projects: allProjects }) => {
    ...
    return (
        <div className="bg-[#f8f9fa] border border-[#dee2e6] rounded-sm shadow-sm overflow-hidden flex flex-col">
            <div className="px-5 py-2.5 border-b border-[#dee2e6] flex justify-between items-center bg-[linear-gradient(180deg,#ffffff_0%,#f1f3f5_100%)]">
                <div className="flex items-center gap-4">
                    <h2 className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                        Aktuelle Projekte
                    </h2>
                    <div className="flex bg-white rounded-sm p-0.5 border border-[#ced4da] shadow-desktop-inset">
                        <button
            ...
            <div className="overflow-x-auto bg-white">
                <table className="w-full text-left border-collapse">
                    <thead className="bg-[#f1f3f5] text-slate-700 text-[10px] font-bold uppercase tracking-tight border-b border-[#dee2e6]">
                        <tr>
                            <th className="px-6 py-2.5 border-r border-[#dee2e6]/50 last:border-r-0">Projekt</th>
                            <th className="px-6 py-2.5 border-r border-[#dee2e6]/50 last:border-r-0">Kunde</th>
                            <th className="px-6 py-2.5 border-r border-[#dee2e6]/50 last:border-r-0">Sprachen</th>
                            <th className="px-6 py-2.5 border-r border-[#dee2e6]/50 last:border-r-0 text-right">Deadline</th>
                    ...
                    <tbody className="divide-y divide-slate-100">
                        {paginatedProjects.map((p) => (
                            <tr
                                ...
                                className="hover:bg-[#e7f5ff]/40 transition-all cursor-pointer group border-b last:border-b-0"
                            >
            ...
            {/* Pagination Controls */}
            {totalPages > 1 && (
                <div className="px-6 py-3 border-t border-[#dee2e6] flex justify-between items-center bg-transparent">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Seite {page} von {totalPages}</span>
