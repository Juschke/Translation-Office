...
const AuditLogsTab = () => {
 ...
 <div className="w-8 h-8 bg-slate-50 text-slate-900 flex items-center justify-center text-xs font-medium border border-slate-100 rounded"><FaUserShield /></div>
 <div>
 <h3 className="text-sm font-medium text-slate-800">Audit Logs / Aktivitätsverlauf</h3>
 <p className="text-xs text-slate-400 font-mediumer">Vollständige Historie aller Systemänderungen</p>
 </div>
 </div>
