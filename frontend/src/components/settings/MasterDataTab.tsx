            ...
            <div className="flex items-center gap-6 border-b border-slate-200 overflow-x-auto">
                {(['languages', 'doc_types', 'services', 'email_templates'] as const).map(t => (
                    <button
                        ...
                        className={clsx('py-3 text-[11px] font-bold uppercase tracking-widest border-b-2 transition whitespace-nowrap', masterTab === t ? 'border-brand-600 text-brand-700' : 'border-transparent text-slate-400 hover:text-slate-600')}
                    >
