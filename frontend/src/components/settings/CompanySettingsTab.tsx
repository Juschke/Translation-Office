                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="col-span-1 md:col-span-2">
                                <div className="space-y-1.5">
                                    <label className="text-2xs font-bold text-slate-400 uppercase tracking-widest ml-1">Öffnungszeiten</label>
                                    <button
                                    ...
                                    >
                                        ...
                                        <span className="text-2xs text-slate-400 font-bold uppercase tracking-wider">Bearbeiten</span>
                                    </button>
                                </div>
                            </div>
                        </div>
