...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
 ...
 ref={ref}
 className={cn(
 "border-b border-slate-200 transition-colors hover:bg-transparent data-[state=selected]:bg-slate-100",
 className
 )}
 {...props}
 />
...
const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
 ...
 ref={ref}
 className={cn(
 "h-10 px-4 text-left align-middle text-sm font-medium text-slate-500 [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
 className
 )}
 {...props}
 />
