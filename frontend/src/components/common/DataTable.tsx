...
const DataTable = <T extends { id: string | number }>({
 ...
 className="w-full pl-8 pr-4 py-1.5 border border-slate-200 rounded-sm text-sm focus:outline-none focus:border-slate-400 bg-transparent"
 />
 </div>
 ...
 <thead className="bg-slate-50 text-slate-500 font-medium text-sm sticky top-0 z-10 border-b border-slate-200">
 <tr>
 ...
 rowIdx === selectedRowIndex && "bg-transparent ring-1 ring-inset ring-slate-300 z-10",
