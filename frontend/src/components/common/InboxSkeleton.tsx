...
const InboxSkeleton = () => {
 ...
 {/* Main Content Area */}
 <div className="flex-1 flex bg-white border border-slate-200 rounded-sm shadow-sm overflow-hidden">
 {/* Sidebar (Folders) */}
 ...
 <Skeleton className="h-16 w-1/3 rounded-sm rounded-tr-none" />
 </div>
 <div className="flex gap-4">
 <Skeleton variant="circular" width={32} height={32} className="shrink-0" />
 <div className="space-y-2 w-2/3">
 <Skeleton className="h-32 w-full rounded-sm rounded-tl-none" />
 </div>
 </div>
 </div>
 </div>
