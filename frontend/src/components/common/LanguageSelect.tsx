...
const LanguageSelect: React.FC<LanguageSelectProps> = ({
 ...
 isMulti ? "bg-slate-50 border border-slate-200 px-2 py-0.5 text-xs font-medium text-slate-700" : "text-sm font-medium text-slate-800"
 )}>
 ...
 <div className="bg-slate-50 border border-slate-100 px-2 py-0.5 text-xs font-medium text-slate-900">
 ...
 values.includes(opt.code) ? "bg-slate-50/30 text-slate-900 font-medium" : "text-slate-700 hover:bg-slate-50"
 )}
 ...
 className="w-full py-2 bg-white hover:bg-slate-100 border border-slate-200 rounded text-xs font-medium text-slate-900 flex items-center justify-center gap-2 transition shadow-sm"
 >
