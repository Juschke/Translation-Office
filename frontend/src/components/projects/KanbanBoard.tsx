            ...
            >
                <div className="flex-1 flex items-center px-4 gap-4">
                    ...
                    <div className="flex flex-col items-center gap-1 pr-2">
                        <div className="flex items-center gap-1.5 text-sm text-slate-400 font-bold whitespace-nowrap">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <div className="flex items-center gap-2">
                                            <h3 className="font-bold text-slate-800 text-[12px]">{section.title}</h3>
                                            <span className={clsx(
                                                "px-1.5 py-0.5 rounded-full text-sm font-bold",
                                                isCollapsed ? "bg-slate-200 text-slate-500" : "bg-brand-primary/10 text-brand-primary"
                                            )}>
                                                {sectionProjects.length}
                                            </span>
                                        </div>
                                        <span className="text-sm text-slate-400 font-bold leading-none">
                                ...
                                <div className="bg-white border-t border-slate-100 min-h-[80px]">
                                    {sectionProjects.length > 0 ? (
                                        ...
                                        <div className="h-20 flex items-center justify-center border-dashed border-2 border-slate-100 m-2 rounded-[2px] opacity-40">
                                            <span className="text-sm font-bold text-slate-300 italic">Bereit für Aufträge</span>
                                        </div>
                                    )}
                                </div>
                            )}
