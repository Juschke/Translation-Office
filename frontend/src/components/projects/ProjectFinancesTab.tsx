                                        ...
                                        <td className="px-4 py-3 text-right text-red-400 font-medium border-l border-slate-100 bg-red-50/5 group-hover:bg-red-50/20 transition-colors">
                                            <div className="flex flex-col gap-0.5 items-end">
                                                ...
                                                <select
                                                    ...
                                                    className="text-right text-[9px] font-bold uppercase text-red-300 bg-transparent outline-none cursor-pointer hover:text-red-500 transition-colors appearance-none"
                                                >
                                ...
                                <tbody className="divide-y divide-slate-100 text-xs border-t-2 border-slate-100">
                                    {projectData.isCertified && (
                                        <tr className="bg-slate-50/50">
                                            ...
                                            <td className="px-4 py-3 text-right text-slate-400 border-l border-slate-100">-</td>
                                            <td className="px-4 py-3 text-right font-black text-slate-800 border-l border-slate-100 bg-emerald-50/10">5,00 €</td>
                                    ...
                                    {projectData.hasApostille && (
                                        <tr className="bg-slate-50/50">
                                            ...
                                            <td className="px-4 py-3 text-right text-slate-400 border-l border-slate-100">-</td>
                                            <td className="px-4 py-3 text-right text-slate-400 border-l border-slate-100">-</td>
                                            <td className="px-4 py-3 text-right font-black text-slate-800 border-l border-slate-100 bg-emerald-50/10">15,00 €</td>
                                            <td className="px-2 py-3"></td>
                                        </tr>
                                    )}
