        ...
        <div className="bg-white rounded-sm border border-slate-200 shadow-sm overflow-hidden animate-fadeIn px-6 mb-10">
            <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center bg-white gap-4">
                <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-4">
                        <h3 className="text-xs font-semibold text-slate-800">Projekt-Dateien</h3>
                    ...
                    <div className="flex bg-slate-100 p-1 rounded-sm w-fit">
                        <button
                            ...
                            className={clsx("px-3 py-1 text-xs font-medium rounded-sm transition", fileFilterTab === 'all' ? "bg-white text-slate-700 shadow-sm" : "text-slate-500 hover:text-slate-700")}
                        >
                            Alle
                        </button>
                        <button
                            onClick={() => setFileFilterTab('source')}
                            className={clsx("px-3 py-1 text-xs font-medium rounded-sm transition", fileFilterTab === 'source' ? "bg-white text-emerald-600 shadow-sm" : "text-slate-500 hover:text-slate-700")}
                        >
                            Quelle
                        </button>
                        <button
                            onClick={() => setFileFilterTab('target')}
                            className={clsx("px-3 py-1 text-xs font-medium rounded-sm transition", fileFilterTab === 'target' ? "bg-white text-blue-600 shadow-sm" : "text-slate-500 hover:text-slate-700")}
                        >
                            Ziel
                        </button>
                    </div>
                ...
                <button
                    ...
                    className="px-4 py-2 bg-slate-900 text-white rounded text-xs font-semibold hover:bg-slate-900 transition shadow-sm flex items-center gap-2"
                >
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                    <thead className="bg-slate-50/80 text-slate-400 text-xs font-semibold border-b border-slate-200">
                        <tr>
                                ...
                                .map((file: any) => {
                                    ...
                                    return (
                                        <tr key={file.id} className="hover:bg-slate-50 transition-colors group">
                                            <td
                                                className="px-6 py-4 font-medium text-slate-700 flex items-center gap-3 cursor-pointer hover:text-slate-700 transition"
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col">
                                                    <span>{fileName}</span>
                                                    <span className="text-xs text-slate-400 font-normaler">{file.original_name}</span>
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-6 py-4 text-slate-600">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-5 h-5 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-xs font-medium text-slate-700">
