                ...
                {menuOpen && (
                    <div className="absolute right-0 top-full mt-1 w-52 bg-white border border-slate-200 shadow-xl rounded-sm py-1 z-[60] animate-fadeIn">
                        <button
                            ...
                            className="w-full text-left px-4 py-2.5 text-xs font-medium text-slate-700 hover:bg-red-50 hover:text-red-600 transition-colors flex items-center justify-between"
                        >
                            <span>Alle Tabs schließen</span>
                        ...
                        {activeTabId && tabs.length > 1 && (
                            <button
                                ...
                                className="w-full text-left px-4 py-2.5 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-brand-primary transition-colors flex items-center justify-between"
                            >
                                <span>Alle anderen Tabs schließen</span>
                                <X className="w-3.5 h-3.5 opacity-50" />
                            </button>
                        )}
                    </div>
