...
const PaymentModal: React.FC<PaymentModalProps> = ({ isOpen, onClose, onSave, initialData, totalAmount }) => {
 ...
 <button onClick={onClose} className="px-4 py-2 text-slate-500 font-medium text-xs hover:text-slate-700 transition">Abbrechen</button>
 <button onClick={handleSave} className="px-6 py-2 bg-slate-900 text-white rounded text-xs font-medium shadow-sm hover:bg-slate-800 transition">
 Speichern
 </button>
 </div>
 </div>
