...
const NewDocTypeModal: React.FC<NewDocTypeModalProps> = ({ isOpen, onClose, onSubmit, initialData, isLoading }) => {
 ...
 type="text"
 className="w-full border border-slate-300 rounded px-3 py-2 text-sm bg-white outline-none focus:border-slate-900 shadow-sm h-10 transition"
 ...
 className="px-8 py-2.5 bg-slate-900 text-white rounded text-xs font-medium shadow-sm hover:bg-slate-800 transition disabled:opacity-50 disabled:scale-100"
 >
