...
const NewMasterDataModal: React.FC<NewMasterDataModalProps> = ({ isOpen, onClose, onSubmit, type, initialData }) => {
    ...
    const getIcon = () => {
        switch (type) {
            case 'languages': return <FaLanguage className="text-brand-600" />;
            case 'doc_types': return <FaFileAlt className="text-brand-600" />;
            case 'services': return <FaGlobe className="text-brand-600" />;
            case 'email_templates': return <FaEnvelopeOpenText className="text-brand-600" />;
            default: return null;
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/40 z-[60] flex items-center justify-center backdrop-blur-sm p-4">
            <div className={clsx(
                "bg-white rounded-lg shadow-2xl w-full overflow-hidden animate-fadeInUp",
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="flex bg-slate-100 p-0.5 rounded border border-slate-200 h-11">
                            <button
                                ...
                                className={clsx("flex-1 text-[9px] font-bold uppercase rounded flex items-center justify-center gap-2 transition", (formData.status || 'active') === 'active' ? "bg-white text-emerald-600 shadow-sm" : "text-slate-400")}
                            >
                                <FaCheck className="text-[10px]" /> Aktiv
                            </button>
                            <button
                                onClick={() => handleChange('status', 'inactive')}
                                className={clsx("flex-1 text-[9px] font-bold uppercase rounded flex items-center justify-center gap-2 transition", formData.status === 'inactive' ? "bg-white text-slate-500 shadow-sm" : "text-slate-400")}
                            >
                                <FaBan className="text-[10px]" /> Inaktiv
                            </button>
                        </div>
                    </div>
                        ...
                        <>
                            <div className="space-y-1.5">
                                ...
                                <input
                                    id="name_internal"
                                    type="text"
                                    className={clsx("w-full h-11 px-3 border rounded outline-none focus:border-brand-500 text-sm transition-all", errors.name_internal ? "border-red-500 bg-red-50" : "border-slate-300 bg-white")}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    id="name_native"
                                    type="text"
                                    className={clsx("w-full h-11 px-3 border rounded outline-none focus:border-brand-500 text-sm transition-all", errors.name_native ? "border-red-500 bg-red-50" : "border-slate-300 bg-white")}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        id="iso_code"
                                        type="text"
                                        className={clsx("w-full h-11 px-3 border rounded outline-none focus:border-brand-500 text-sm  transition-all", errors.iso_code ? "border-red-500 bg-red-50" : "border-slate-300 bg-white")}
                                        placeholder="de-DE"
                                ...
                                <div className="space-y-1.5">
                                    <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest">Flaggen-Code (2-Stellig)</label>
                                    <input
                                        type="text"
                                        className="w-full h-11 px-3 border border-slate-300 rounded outline-none focus:border-brand-500 text-sm  bg-white"
                                        placeholder="de"
                                        maxLength={2}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    id="name"
                                    type="text"
                                    className={clsx("w-full h-11 px-3 border rounded outline-none focus:border-brand-500 text-sm transition-all", errors.name ? "border-red-500 bg-red-50" : "border-slate-300 bg-white")}
                    ...
                    {type === 'services' && (
                        <>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest">Einheit</label>
                                    <select
                                        className="w-full h-11 px-3 border border-slate-300 rounded outline-none focus:border-brand-500 text-sm bg-white"
                                        value={formData.unit || ''}
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        id="base_price"
                                        type="text"
                                        className={clsx("w-full h-11 px-3 border rounded outline-none focus:border-brand-500 text-sm transition-all", errors.base_price ? "border-red-500 bg-red-50" : "border-slate-300 bg-white")}
                                        placeholder="0.12"
                        ...
                        <>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    id="subject"
                                    type="text"
                                    className={clsx("w-full h-11 px-3 border rounded outline-none focus:border-brand-500 text-sm transition-all", errors.subject ? "border-red-500 bg-red-50" : "border-slate-300 bg-white")}
                            ...
                            <div className="space-y-1.5">
                                <div className="flex justify-between items-end mb-1">
                                    <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest">Inhalt <span className="text-red-500">*</span></label>
                                    <button
                                        onClick={() => setShowPreview(!showPreview)}
                                        className="text-[10px] font-bold uppercase tracking-widest text-brand-600 hover:text-brand-700 flex items-center gap-1 bg-brand-50 px-2 py-0.5 rounded border border-brand-100"
                                    >
                                        ...
                                        <div className="flex flex-wrap gap-1 mb-2">
                                            {availableVariables.map((v) => (
                                                <button
                                                    ...
                                                    className="px-2 py-1 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded text-[10px] font-bold text-slate-600 hover:text-brand-600 transition uppercase tracking-tight"
                ...
                <div className="bg-slate-50 px-6 py-4 border-t border-slate-200 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className="px-6 py-2.5 bg-brand-700 text-white rounded text-xs font-bold uppercase tracking-widest hover:bg-brand-800 shadow-md transition active:scale-95 flex items-center gap-2"
                    >
                        <FaSave /> Speichern
                    </button>
                </div>
                    ...
                    <div className="bg-white rounded-lg shadow-2xl w-full max-w-sm overflow-hidden animate-scaleIn">
                        ...
                        <div className="p-6">
                            ...
                            <input
                                autoFocus
                                type="text"
                                className="w-full h-11 px-3 border border-slate-300 rounded outline-none focus:border-brand-500 text-sm"
