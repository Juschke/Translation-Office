...
class MasterDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 1. Languages A-Z (Common + Broad coverage)
        $languages = [
            ...
            ['iso_code' => 'eu-ES', 'name_internal' => 'Baskisch', 'name_native' => 'Euskara', 'flag_icon' => 'es-ct'],
            ...
            ['iso_code' => 'zh-CN', 'name_internal' => 'Chinesisch (Vereinfacht)', 'name_native' => '简体中文', 'flag_icon' => 'cn'],
            ['iso_code' => 'zh-TW', 'name_internal' => 'Chinesisch (Traditionell)', 'name_native' => '繁體中文', 'flag_icon' => 'tw'],
            ['iso_code' => 'da-DK', 'name_internal' => 'Dänisch', 'name_native' => 'Dansk', 'flag_icon' => 'dk'],
            ['iso_code' => 'de-DE', 'name_internal' => 'Deutsch (Deutschland)', 'name_native' => 'Deutsch', 'flag_icon' => 'de'],
            ['iso_code' => 'de-AT', 'name_internal' => 'Deutsch (Österreich)', 'name_native' => 'Deutsch', 'flag_icon' => 'at'],
            ['iso_code' => 'de-CH', 'name_internal' => 'Deutsch (Schweiz)', 'name_native' => 'Deutsch', 'flag_icon' => 'ch'],
            ['iso_code' => 'en-GB', 'name_internal' => 'Englisch (UK)', 'name_native' => 'English (UK)', 'flag_icon' => 'gb'],
            ['iso_code' => 'en-US', 'name_internal' => 'Englisch (USA)', 'name_native' => 'English (US)', 'flag_icon' => 'us'],
            ...
            ['iso_code' => 'fr-FR', 'name_internal' => 'Französisch (Frankreich)', 'name_native' => 'Français', 'flag_icon' => 'fr'],
            ['iso_code' => 'fr-CA', 'name_internal' => 'Französisch (Kanada)', 'name_native' => 'Français (Canada)', 'flag_icon' => 'ca'],
            ...
            ['iso_code' => 'pt-PT', 'name_internal' => 'Portugiesisch (Portugal)', 'name_native' => 'Português (Portugal)', 'flag_icon' => 'pt'],
            ['iso_code' => 'pt-BR', 'name_internal' => 'Portugiesisch (Brasilien)', 'name_native' => 'Português (Brasil)', 'flag_icon' => 'br'],
            ...
            ['iso_code' => 'es-ES', 'name_internal' => 'Spanisch (Spanien)', 'name_native' => 'Español', 'flag_icon' => 'es'],
            ['iso_code' => 'es-MX', 'name_internal' => 'Spanisch (Mexiko)', 'name_native' => 'Español (México)', 'flag_icon' => 'mx'],
        ...
        $docTypes = [
            'Urkunde / Zeugnis',
            'Vertrag / Rechtliches Dokument',
            'Medizinischer Befund / Bericht',
        ...
        foreach ($docTypes as $name) {
            DocumentType::updateOrCreate(['tenant_id' => $tenantId, 'name' => $name]);
        }
