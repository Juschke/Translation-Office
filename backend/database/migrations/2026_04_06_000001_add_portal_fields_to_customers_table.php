...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('customers', function (Blueprint $table) {
            $table->boolean('portal_access')->default(false)->after('status');
            $table->string('portal_token')->nullable()->after('portal_access');
            $table->timestamp('portal_token_expires_at')->nullable()->after('portal_token');
            $table->string('portal_session_token')->nullable()->after('portal_token_expires_at');
