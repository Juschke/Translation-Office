    ...
    */
    ...
    'servers' => [
        ...
        'reverb' => [
            ...
            'port' => env('REVERB_SERVER_PORT', 443), // HTTPS port by default
    ...
    'apps' => [
        ...
        'apps' => [
            [
                ...
                'allowed_origins' => explode(',', env('REVERB_ALLOWED_ORIGINS', 'http://localhost:5173,http://localhost:3000,http://127.0.0.1:5173')),
